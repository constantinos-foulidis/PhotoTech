...
class RantevouPoliton extends Component {
           constructor(props){
             super(props);
...
const mapStateToProps = (state, props) => {
  return {
    appointmentsById: state.sellers.appointmentsById,
...
export default connect(mapStateToProps, mapDispatchToProps)(RantevouPoliton);
