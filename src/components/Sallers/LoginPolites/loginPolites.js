...
class LoginPolites extends Component {
  constructor(props) {
    super(props);
    this.state = {
      username: '',
...
const mapStateToProps = (state, props) => {
  return {
    ...
    isLogedInPOLITES: state.loginPolites.isLogedInPOLITES,
...
export default connect(mapStateToProps, mapDispatchToProps)(LoginPolites);
