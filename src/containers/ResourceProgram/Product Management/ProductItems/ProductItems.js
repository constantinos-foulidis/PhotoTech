                ...
                <div key={product.productCode} className="col-auto">
                  <ProductItem
                    ...
                    onDelete={() => {
                      ...
                      this.setState({ productForDelete: product.productCode });
                    }}
                    product={product}
                    Specified={() => {
                      this.props.setProductSpecks(product);
                      handleSpecified();
                    }}
                  />
                </div>
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    setProductSpecks: productSpecks =>
      dispatch(actions.setProductsSpecks(productSpecks))
  };
};
