        ...
        showEverything = (
         ...
         <div className="row">
           <div className="col-5 border">
             <img alt="Product" className="imgflex onHoverEfect" src={imagePath} onClick={this.handleShowImage} />
           </div>
           ...
           <Modal.Body>
             <Container>
               <Row className="show-grid mb-4">
                 <Col xs={12} md={8}>
                   <input type="number" placeholder="Αριθμος" onChange={(event) => this.numberChanged(event)} />
                 </Col>
               </Row>
         ...
         <Modal aria-labelledby="contained-modal-title-vcenter" size="lg"show={this.state.showImage} onHide={this.handleCloseImage}>
           <Modal.Header closeButton="closeButton">
           </Modal.Header>
           <Modal.Body>
             <Container>
